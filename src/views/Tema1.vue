    ...
    .tarjeta.p-4(style="background-color: #f1fcf3").mb-5
      LineaTiempoC.color-primario(text-small)
        .row(titulo="Paso 1").align-items-center.justify-content-center
          ...
          .col-md-5.col-10: img(src='@/assets/curso/temas/tema1/9.png', alt='')
        .row(titulo="Paso 2").align-items-center.justify-content-center
          ...
          .col-md-5.col-10: img(src='@/assets/curso/temas/tema1/10.png', alt='')
        ...
        .row(titulo="Paso 5").align-items-center.justify-content-center
          ...
          .col-md-5.col-10: img(src='@/assets/curso/temas/tema1/13.png', alt='')
        .row(titulo="Paso 6").align-items-center.justify-content-center
          .col-md-7.mb-4.mb-md-0
          ...
          .col-md-5.col-10: img(src='@/assets/curso/temas/tema1/14.png', alt='')
        .row(titulo="Paso 7").align-items-center.justify-content-center
          .col-md-7.mb-4.mb-md-0
          ...
          .col-md-5.col-10: img(src='@/assets/curso/temas/tema1/15.png', alt='')
    .titulo-cuadro.d-flex
      i.fas.fa-square(style="color: #3bc192").me-3
      h4 Área de cortes
      ...
      .col-lg-10
          LineaTiempoD.color-primario
            ...
            .row(numero="2" titulo="Paso 2").justify-content-center
              ...
              .col-lg-5.col-10: img(src='@/assets/curso/temas/tema1/17.png', alt='')
            .row(numero="3" titulo="Paso 3").justify-content-center
              .col-lg-7
              ...
              .col-lg-5.col-10: img(src='@/assets/curso/temas/tema1/18.png', alt='')
            .row(numero="4" titulo="Paso 4").justify-content-center
              .col-lg-7
              ...
              .col-lg-5.col-10: img(src='@/assets/curso/temas/tema1/19.png', alt='')
            .row(numero="5" titulo="Paso 5").justify-content-center
              .col-lg-7
            ...
            .row(numero="7" titulo="Paso 7").justify-content-center
              ...
              .col-lg-5.col-10: img(src='@/assets/curso/temas/tema1/22.png', alt='')
    .titulo-cuadro.d-flex
      i.fas.fa-square(style="color: #3bc192").me-3
